...
Για τον ορισμό της νέας μεταβλητής στο SPSS, όπως και πριν, πηγαίνουμε στο μενού: \en{Transform | Recode Into different Variables...} (βλ. σχήμα \ref{}).
...
Κατ` ουσία είναι έλεγχος σημαντικότητας και ισοδυναμεί με τον ακόλουθο στατιστικό έλγεχο:
...
Για τον έλεγχο της υπόθεσης στο SPSS πηγαίνουμε στο μενού: \en{Analyze|General Linear Model| Univariate} (βλ. σχήμα \ref{}) και προκύπτει ο πίνακας \ref{}. 
...
%Analyze|General Linear Model| Univariate. Στην επιλογή Save τώρα τικάρουμε στο Predicted Values to Unstandardized.
...
Η εξαρτημένη μεταβλητή (\en{yr}) είναι ποιοτική μεταβλητή με 2 επίπεδα. Επομένως ως μέθοδο θα χρησιμοποιήσουμε την λογιστική παλινδρόμηση. Αρχικά θα εφαρμοστεί έλεγχος καλής προσαρμογής του 
...
Πρέπει πρώτα να συμπληρώσουμε μία επιλέον γραμμή με αυτά που θέλουμε.
Analyze|Regresion| Binary Logistic. Στην επιλογή Save στο Predicted Values τικάρουμε το 
Probabilities. Δίνει απ` ευθείας την πιθανότητα και συγκεκριμένα η πιθανότητα y=1
